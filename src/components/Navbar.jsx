...
// const CV_VIEW_URL     = 'https://drive.google.com/file/d/1FnDXe5dw8gAN87al9sQL_2f6WK_4BGk_/view'
// const CV_DOWNLOAD_URL = 'https://drive.google.com/uc?export=download&id=1FnDXe5dw8gAN87al9sQL_2f6WK_4BGk_'
...
export default function Navbar() {
  ...
  const CV_URL = 'https://drive.google.com/file/d/1FnDXe5dw8gAN87al9sQL_2f6WK_4BGk_/view?usp=sharing'
      ...
      {menuOpen && (
        <div className="md:hidden bg-gray-900/95 backdrop-blur px-6 pb-6">
          ...
          <a href={CV_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 block text-center bg-green-400 hover:bg-green-300 text-gray-900 font-semibold px-5 py-2 rounded-full text-sm transition-colors duration-200">
            Download CV
          </a>
        </div>
      )}
